...
class ComplicationController: NSObject, CLKComplicationDataSource {
  ...
  // MARK: - Complication Configuration
    ...
    func getComplicationDescriptors(handler: @escaping ([CLKComplicationDescriptor]) -> Void) {
            let descriptors = [
                CLKComplicationDescriptor(identifier: "complication", displayName: "Nomie6", supportedFamilies: [CLKComplicationFamily.circularSmall, CLKComplicationFamily.graphicCircular, CLKComplicationFamily.graphicCorner,CLKComplicationFamily.modularSmall])
